...
| MF-P6-02 | `serve\api.py` | /health /models /predict /refine with the shared Pod GPU lease around every GPU child | latency targets met warm; guarded selected-pod execution demonstrated | 13 §3 |

...
Masking System for Kevin, using governed local/RunPod/Serverless/CPU routes,
from an empty repo to a
...
remain first-class optional profiles. The complete specification is in
`Plan\00` through `Plan\27`; doc 24 remains the completion/bridge authority
and doc 27 adds the self-hosted continuous-throughput acceptance track.

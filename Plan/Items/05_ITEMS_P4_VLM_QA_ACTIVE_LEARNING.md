...
- [ ] MF-P4-01.01 `vlm\client.py`: Ollama API client (127.0.0.1:11434) · every production RunPod GPU review child uses `tools/run_with_shared_pod_gpu_lease.py` and the shared FIFO lease

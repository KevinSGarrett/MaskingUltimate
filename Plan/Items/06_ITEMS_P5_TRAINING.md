...
- [ ] MF-P5-03.02 Train SegFormer-B3 on RunPod through `tools/run_with_shared_pod_gpu_lease.py` · eval per-part IoU + boundary-F on val every 4k
...
- [ ] MF-P5-08.03 (Optional) RunPod scale runbook executed once: validate persistent inputs · train through the shared guarded launcher on the selected pod · persist/hash outputs and evidence

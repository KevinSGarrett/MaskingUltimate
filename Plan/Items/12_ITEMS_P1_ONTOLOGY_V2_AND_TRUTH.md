...
- [ ] MF-P1-10.08 Wire CI to prove IDs 0..55 unchanged and 56..64 contiguous · Verify: deliberate prefix or gap drift fails CI · Blocked by: MF-P1-10.07 · HARD BLOCKER
...
- [ ] MF-P1-12.09 Pilot 20–30 governed source images covering all v2 states and applicable classes · Verify: distinct-image manifest report covers the required state/class matrix · Blocked by: NEEDS KEVIN: supply/authorize the pilot sources and perform any required human-anchor decisions
...
- [ ] MF-P1-13.02 Require human anchors to declare train, calibration, or holdout partition and enforce image-disjoint identity/pHash groups · Verify: cross-partition leakage fixtures fail · Blocked by: MF-P1-13.01 · HARD BLOCKER

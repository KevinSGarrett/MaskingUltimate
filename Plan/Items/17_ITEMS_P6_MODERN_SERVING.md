...
- [ ] MF-P6-06.03 Keep SAM2.1 as incumbent interactive/CVAT fallback until SAM 3.1 wins exact role benchmarks; preserve one-command rollback · Verify: active/fallback selection and rollback smokes pass · Blocked by: MF-P2-11.15

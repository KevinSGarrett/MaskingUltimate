...
evidence = {
    ...
    "docker_ps_sample": {
        ...
        "production_cvat_traefik_nuclio": [
            ...
            {"name": "cvat_worker_annotation", "image": "cvat/server:v2.24.0", "status": "Up 9 minutes"},
            {"name": "cvat_worker_import", "image": "cvat/server:v2.24.0", "status": "Up 9 minutes"},
            {"name": "cvat_worker_export", "image": "cvat/server:v2.24.0", "status": "Up 9 minutes"},
            {"name": "cvat_worker_chunks", "image": "cvat/server:v2.24.0", "status": "Up 9 minutes"},
            {"name": "cvat_worker_webhooks", "image": "cvat/server:v2.24.0", "status": "Up 9 minutes"},
            {"name": "cvat_worker_quality_reports", "image": "cvat/server:v2.24.0", "status": "Up 9 minutes"},
            {"name": "cvat_worker_analytics_reports", "image": "cvat/server:v2.24.0", "status": "Up 9 minutes"},
            ...
            {"name": "cvat_redis_ondisk", "image": "apache/kvrocks:2.7.0", "status": "Up 9 minutes (healthy)"},
            {"name": "cvat_clickhouse", "image": "clickhouse/clickhouse-server:23.11-alpine", "status": "Up 9 minutes"},
            {"name": "cvat_opa", "image": "openpolicyagent/opa:0.63.0", "status": "Up 9 minutes"},
            {"name": "cvat_grafana", "image": "grafana/grafana-oss:10.1.2", "status": "Up 9 minutes"},
            {"name": "cvat_vector", "image": "timberio/vector:0.26.0-alpine", "status": "Up 9 minutes"},
            {"name": "traefik", "image": "traefik:v3.6.1", "status": "Up 9 minutes"},
            {"name": "nuclio", "image": "quay.io/nuclio/dashboard:1.13.0-amd64", "status": "Up 9 minutes (healthy)"},
            {"name": "nuclio-nuclio-pth-sam2", "image": "cvat.pth.sam2:latest", "status": "Up 9 minutes (healthy)"},
            {"name": "nuclio-local-storage-reader", "image": "gcr.io/iguazio/alpine:3.17", "status": "Up 9 minutes"},
        ],

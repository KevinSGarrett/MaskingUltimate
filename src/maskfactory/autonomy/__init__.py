...
_EXPORTS: Final[dict[str, tuple[str, str]]] = {'CandidateEvidence': ('tournament', 'CandidateEvidence'),
 ...
 'MultiPersonCertificationScopeResult': ('multi_person_scope',
 ...
 'evaluate_multi_person_candidate_gate': ('multi_person_gate',
                                          'evaluate_multi_person_candidate_gate'),
 'evaluate_multi_person_certification_scope': ('multi_person_scope',
 ...
 'HIGHEST_VISUAL_TIER_WITH_RESIDUALS': ('visual_defect_policy',
                                        'HIGHEST_VISUAL_TIER_WITH_RESIDUALS'),
 'STRUCTURAL_ABSTAIN_DEFECT_CLASSES': ('visual_defect_policy', 'STRUCTURAL_ABSTAIN_DEFECT_CLASSES'),

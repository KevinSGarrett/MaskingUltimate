...
def render_boundary_panel(
    ...
    *,
    ...
    if not target.any() or tile_size != 512 or zoom_multiplier < 1.2 or zoom_multiplier > 3.0:
        raise PanelError("panel requires nonempty mask, 512 tiles, and zoom in [1.2, 3.0]")

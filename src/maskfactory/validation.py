...
SCHEMA_NAMES = frozenset(
    {
        ...
        "selective_autonomy_targets_static_report",
        "horizon_go_no_go_static_report",
        "ops_static_contracts_report",
        "ops_bootstrap_static_report",
        "selective_autonomy_e2e_static_report",
        "civitai_workflow_intake_static_report",
        ...
        "autonomous_gold_qa_threshold_calibration",
        "autonomous_gold_per_record_qa_vector",
        ...
        "specialist_static_contracts_report",
        "completion_profile",

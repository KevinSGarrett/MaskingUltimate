...
def materialize_lv_mhp_direct_control_panels(
    *, source_root: Path, candidate_document: Mapping[str, Any], output_root: Path
    ...
    source_value, canonical_label = int(policy["exact_source_values"][0]), str(
        policy["canonical_label"]
    )
    ...
    try:
            ...
            records.append(
                {
                    **row,
                    ...
                    "direct_remap_pixels_verified": True,
                    **panels,
        ...
        report: dict[str, Any] = {
            ...
            "artifact_type": "lv_mhp_v1_exact_direct_visual_evidence",
            ...
            "claim_limits": [
                ...
                "No critic-control, gold, certificate, package, or production authority is granted.",
            ],
        }
...
def verify_lv_mhp_direct_control_panel_report(document: Mapping[str, Any], root: Path) -> None:
    ...
    if (
        document.get("self_sha256") != canonical_sha256(sealed)
        or document.get("schema_version") != SCHEMA
        or document.get("artifact_type") != "lv_mhp_v1_exact_direct_visual_evidence"
    ...
    for row in rows:
        if (
            ...
            or row.get("direct_remap_pixels_verified") is not True
        ):
        ...
        for name in PANEL_NAMES:
            ...
            try:
                ...
                raise LvMhpDirectControlPanelError("panel path escape") from exc

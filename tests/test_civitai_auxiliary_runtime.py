...
def _auxiliary_payload_cache_available() -> bool:
...
def test_runtime_covers_registry_and_uses_tiered_authority():
    if not _auxiliary_payload_cache_available():
        pytest.skip("external Civitai payload cache is not mounted in this checkout")

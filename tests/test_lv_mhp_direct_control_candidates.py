...
from maskfactory.vlm.lv_mhp_direct_control_candidates import (
    LvMhpDirectControlCandidateError,
    verify_lv_mhp_direct_control_candidates,
)
...
def _document() -> dict[str, object]:
    row = {
        ...
        "instance_annotation_dimensions": [8, 8],
        "source_sha256": "a" * 64,
        "instance_annotation_sha256": "b" * 64,
    }
...
def test_reject_direct_label_drift() -> None:
    ...
    document["self_sha256"] = canonical_sha256(

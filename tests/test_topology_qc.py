...
def test_qc028_semantic_pose_vote_overrides_crossed_screen_position() -> None:
    shape = (100, 100)
    right_foot = np.zeros(shape, bool)
    right_foot[80:95, 70:90] = True
    result = _result(
        TopologyInputs(
            masks={"right_foot_base": right_foot},
            side_reference_x={"left": 75, "right": 25},
            anatomical_side_votes={"right_foot_base": "right"},
        ),
        "QC-028",
    )

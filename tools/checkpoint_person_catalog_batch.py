...
from maskfactory.nude_person_catalog_queue_bridge import (  # noqa: E402
...
def main() -> None:
    ...
    result = bridge_person_catalog_batch_to_queue(
        catalog_batch_path=args.catalog_batch,
        nude_shard_path=args.nude_shard,
        output_path=args.output,
        queue=NudeBatchQueue(args.queue),
        platform=args.platform,
        shard_path=args.queue_shard_path,
